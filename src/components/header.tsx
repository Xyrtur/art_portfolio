...
function NavItem({hrefName, name}:{hrefName:string, name:string}) { return(<Link href={hrefName} className="hover:text-link-color hover:underline px-8">
{name}
</Link>);
}
...
const Header = () => {
  return (
    <div className="grid grid-rows-2 grid-flow-col p-8 justify-between"><Link href="/">
      <p className="font-kolker_brush text-7xl text-white pl-6 pr-3">
        Ysabelle
      </p>
      <p className="font-kolker_brush text-7xl/6 text-white pl-16">
      Kmiec</p>
      </Link>
